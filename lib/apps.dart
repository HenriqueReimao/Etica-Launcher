...
bool isSettingsApp(Application app) {
  return app.packageName == 'com.android.settings' ||
        ...
        return Scaffold(
          ...
          body: appsInfo.when(
            data: (List<Application> apps) {
              final filteredApps =
                  apps.where((app) => !isSettingsApp(app)).toList();
              return mode == DisplayMode.List
                  ? ListView.builder(
                  ...
                  : GridView(
                      ...
                      children: [
                        ...filteredApps.map((app) => AppGridItem(
